...
export async function deleteMatchdayGroup(matchdayId, groupId, token) {
  const res = await footballApi.delete(`/admin/matchdays/${matchdayId}/groups/${groupId}`, { headers: { Authorization: `Bearer ${token}` } });
  return res.data;
}
